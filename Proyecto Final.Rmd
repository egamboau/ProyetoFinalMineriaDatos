...
La exactitud del modelo es de 93%, especificidad de 95%. Sin embargo, su sensibilidad es tan solo de 6%.

#Resultados

+ La exactitud de los modelos es bastante alta, sin embargo esto puede ser porque la mayoría de las
observaciones indican que no compraron seguro de caravana.
