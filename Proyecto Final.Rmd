...
modelo2.arbol = rpart(CARAVAN ~ MOSTYPE+MGEMLEEF+MINKGEM, data= datos.entrenamiento)
prp(modelo2.arbol)
```
...
modelo2.bosque = randomForest(CARAVAN ~ MOSTYPE+MGEMLEEF+MINKGEM, data= datos.entrenamiento)
...
modelo2.logistica <- glm(CARAVAN ~ MOSTYPE+MGEMLEEF+MINKGEM, data = datos.entrenamiento, family = binomial)
